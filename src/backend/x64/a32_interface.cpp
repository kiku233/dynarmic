...
static RunCodeCallbacks GenRunCodeCallbacks(A32::UserConfig& config, CodePtr (*LookupBlock)(void* lookup_block_arg), void* arg) {
...
struct Jit::Impl {
    Impl(Jit* jit, A32::UserConfig config)
            : block_of_code(GenRunCodeCallbacks(config, &GetCurrentBlockThunk, this), JitStateInfo{jit_state}, GenRCP(config))
