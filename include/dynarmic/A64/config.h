...
struct UserCallbacks {
    ...
    // Writes through these callbacks may not be aligned.
    virtual bool MemoryWriteExclusive8(VAddr vaddr, std::uint8_t value, std::uint8_t /* expected */) { MemoryWrite8(vaddr, value); return true; }
    virtual bool MemoryWriteExclusive16(VAddr vaddr, std::uint16_t value, std::uint16_t /* expected */) { MemoryWrite16(vaddr, value); return true; }
    virtual bool MemoryWriteExclusive32(VAddr vaddr, std::uint32_t value, std::uint32_t /* expected */) { MemoryWrite32(vaddr, value); return true; }
    virtual bool MemoryWriteExclusive64(VAddr vaddr, std::uint64_t value, std::uint64_t /* expected */) { MemoryWrite64(vaddr, value); return true; }
    virtual bool MemoryWriteExclusive128(VAddr vaddr, Vector value, Vector /* expected */) { MemoryWrite128(vaddr, value); return true; }
